...
export const rdsComparisonService = Object.freeze({
  ...
  sourceNote: "Source: AWS public price-list snapshots. Scope: us-east-1, database instances, On Demand, USD, and hourly usage. Engine, edition, licensing, deployment, storage mode, and the AWS pricing operation remain explicit dimensions.",
